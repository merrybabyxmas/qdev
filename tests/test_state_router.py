...
class TestStateRouter(unittest.TestCase):
    ...
    def test_hard_rules_event_shock(self):
        ...
        action = self.router.route_execution(state, prediction=10.0)
    ...
    def test_stable_trend_aggressive(self):
        ...
        action = self.router.route_execution(state, prediction=1.0)
    ...
    def test_stable_mean_reversion_passive(self):
        ...
        action = self.router.route_execution(state, prediction=0.5)
